...
public class ModificaStanzaCtrl {
    ...
    public void initialize() {
        try { init_AggiungiDocStanzaCtrl(); } catch(Exception e) { /* ignore */ }
        try { init_RimuoviDocStanzaCtrl(); } catch(Exception e) { /* ignore */ }
        try { init_PermessiDocStanzaCtrl(); } catch(Exception e) { /* ignore */ }
        try { init_ModificaNomeStanzaCtrl(); } catch(Exception e) { /* ignore */ }
    }
...
@FXML private TableView<DocumentoEntity> documentiDisponibiliTable;
    ...
    private void caricaDatiStanza() {
        if (documentiStanzaTable == null) return;
