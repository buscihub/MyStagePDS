...
CREATE TABLE CARRIERA (
    idCarriera INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE STANZA (
    idStanza INTEGER PRIMARY KEY AUTOINCREMENT,
    codiceFiscaleArtist CHAR(16) NOT NULL,
...
CREATE TABLE VISUALIZZATORE (
    idVisualizzatore INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE VISUALIZZAZIONE (
    idVisualizzazione INTEGER PRIMARY KEY AUTOINCREMENT,
